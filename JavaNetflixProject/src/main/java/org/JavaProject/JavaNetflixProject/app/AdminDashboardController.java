...
import org.JavaProject.JavaNetflixProject.DAO.CategoryDAO;
...
public class AdminDashboardController {
    ...
    public void initialize() {
        adminNameLabel.setText("Admin: " + Session.getCurrentUser().getNom());
    ...
    public void onLogout() {
        Session.logout();
        try { Navigator.navigateTo("/ui/Login.fxml", 900, 600); }
